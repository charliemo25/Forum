...
<main class="container mt-5">
    <div class="row">
        <div class="col">
            <h1>Bienvenue sur la liste des posts !</h1>
            <?php
            /** @var Post $post */
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo "/posts/".$post->getId() ?>" class="btn btn-outline-primary">Consulter la discussion <span class="fw-bold"><?php echo $post->getTitle() ?></span></a>
                </div>
            </div>
            <?php } ?>
        </div>
